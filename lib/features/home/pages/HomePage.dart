...
class _HomepageState extends State<Homepage> {
  ...
  String categoryName(BuildContext context, int index) {
    switch (index) {
      ...
      case 1:
        return AppStrings.laptops(context);

      case 2:
        return AppStrings.smartphones(context);

      case 3:
        return AppStrings.tablets(context);

      case 4:
        return AppStrings.accessories(context);

      case 5:
        return AppStrings.gaming(context);

      case 6:
        return AppStrings.wearables(context);
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      AppStrings.searchProducts(context),
